 ...
 */
@Ignore
public class NodeTypeSetTest<T extends Node>
   ...
   *          the node type
   */
  private NodeTypeSetTest(final _StructureTest<?> owner,
   ...
   *          the node type
   */
  protected NodeTypeSetTest(final NodeTypeSet<T> type) {
    this(null, type);
  }
  ...
  static void _testNodeTypeSet(final _StructureTest<?> owner,
    ...
    owner._test(nodeTypeSet,
        () -> new NodeTypeSetTest<>(owner, nodeTypeSet)
            .runAllTests());
  }
  ...
  public static void
    ...
    new NodeTypeSetTest<>(nodeTypeSet).runAllTests();
  }
}

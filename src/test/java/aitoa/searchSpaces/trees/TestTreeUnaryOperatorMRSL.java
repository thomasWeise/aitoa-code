...
@Ignore
public class TestTreeUnaryOperatorMRSL
  ...
  /** the unary operator */
  private final TreeUnaryOperatorMRSL mUnary;
   ...
   *          the maximum depth
   */
  public TestTreeUnaryOperatorMRSL(final int pMaxDepth) {
    ...
    this.mUnary = new TreeUnaryOperatorMRSL(pMaxDepth);
  }
  ...
  /** {@inheritDoc} */
  @Override
  protected TreeUnaryOperatorMRSL
  ...
  public void testApplyValidAndDifferentAndDepthTest() {
    ...
    final TreeUnaryOperatorMRSL op = this.getOperator(space);

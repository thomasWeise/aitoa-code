...
/**
 * test the unary 12-swap search operator with random enumeration
 * order
 */
public class TestJSSPUnaryOperator12SwapR
  ...
  private static final JSSPSearchSpace SPACE =
      new JSSPSearchSpace(TestJSSPUnaryOperator12SwapR.PROBLEM);

  /** the operator we use */
  private static final IUnarySearchOperator<int[]> OP =
      new JSSPUnaryOperator12SwapR(
          TestJSSPUnaryOperator12SwapR.PROBLEM);

  /** {@inheritDoc} */
  @Override
  protected ISpace<int[]> getSpace() {
    return TestJSSPUnaryOperator12SwapR.SPACE;
  }
  ...
  protected IUnarySearchOperator<int[]>
    ...
    return TestJSSPUnaryOperator12SwapR.OP;
  }
  ...
  protected int[] createValid() {
    return JSSPTestUtils
        .createValidX(TestJSSPUnaryOperator12SwapR.PROBLEM);
  }

...
// end relevant
   ...
   *          the model
   */
  public EDAWithClearing(
      final INullarySearchOperator<X> pNullary, final int pMu,
      final int pLambda, final IModel<X> pModel) {
    super(pNullary);
...
// end relevant
  ...
  public String toString() {
    return Experiment.nameFromObjectsMerge("edac", //$NON-NLS-1$

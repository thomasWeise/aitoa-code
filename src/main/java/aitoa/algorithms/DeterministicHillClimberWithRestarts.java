 ...
 */
// start relevant
public final class DeterministicHillClimberWithRestarts
    implements IMetaheuristic {

// end relevant
  /** create */
  public DeterministicHillClimberWithRestarts() {
    super();
  }
...
// end relevant
    ...
    double[] f_best = new double[1]; // needs to be array
// start relevant

...
It is an attempt to make a new version of <a href="https://thomasweise.github.io/research/publications#W2009GOEB">Global Optimization Algorithms &mdash; Theory and Application</a> with a Java code base backing it and based on an experiment.
...
The [book](http://thomasweise.github.io/aitoa) is available in the following formats:
...
How to run experiments with this code is discussed and shown in the book "[An Introduction to Optimization Algorithms](http://thomasweise.github.io/aitoa)".
...
A description of the format of the data generated by the experimenter is provided [here](https://github.com/thomasWeise/aitoa-code/blob/master/DATAFORMAT.md).
